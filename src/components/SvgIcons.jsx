...
class SvgIcon extends React.Component {
	...
	render() {
		return (
			<svg
				className={cn("icon", this.props.className)}
	...
	svg() {
		return (
			<g transform="scale(.037296)">
				...
				<rect
					transform="matrix(-.7071 -.7071 .7071 -.7071 429.34 1036.2)"
					x="387.09"
					y="420.77"
					width="84.379"
					height="16.859"
...
export class ListModifications extends SvgIcon {
	...
	render() {
		return (
			<svg
				className={cn("modicon", this.props.className)}
				style={this.props.style}
				viewBox={this.viewBox()}
			>
				{this.svg()}
